        ...
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          ...
          <div className="plan-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20 }}>
            ...
            <div className="card" style={{ padding: '32px' }}>
              ...
              <button className="btn-outline-teal" onClick={() => { sessionStorage.setItem('redirectAfterLogin', '/checkout'); navigate('/login?redirect=/checkout'); }} style={{ width: '100%', justifyContent: 'space-between', marginTop: 24 }}>
            ...
            <div style={{ background: 'linear-gradient(145deg,#0d1117,#000000)', border: '1.5px solid #000000', borderRadius: 0, padding: '32px', position: 'relative', overflow: 'hidden' }}>
              ...
              <button className="btn-primary" onClick={() => { sessionStorage.setItem('redirectAfterLogin', '/checkout'); navigate('/login?redirect=/checkout'); }} style={{ width: '100%', justifyContent: 'space-between', marginTop: 24 }}>
